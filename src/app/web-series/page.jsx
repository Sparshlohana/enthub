...
const Page = () => {
    ...
    const getMovies = async () => {
        try {
            const response = await axios.get(`/api/web-series?page=${page}`);
    ...
    const searchMovies = async () => {
        try {
            ...
            const response = await axios.get(`/api/web-series/search?query=${search}`);
            setMovies(response.data.results);
        } catch (error) {
            console.log(error.message);
        }
            ...
            <div className="">
                <div className="flex justify-center py-5 mt-5">
                    <form class="form shadow-md">
                        ...
                        <input class="input" placeholder="Search for your series" required="" type="text" onChange={(e) => {
